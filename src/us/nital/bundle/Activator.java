...
/**
 * This interface provides the blueprints for a bundle activator.
 * 
 * <p>Every activator performs specific command to deploy or 
 * undeploy a bundle component. This is achieved by calling the 
 * well-defined {@link #start} and {@link #stop} methods.</p>
 * 
 * @author Thomas Nappo
 */
